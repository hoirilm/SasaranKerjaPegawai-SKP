...
require 'pages/staf/notif.php';
require 'pages/staf/reset-error.php';
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="" action="pages/staf/proses-ubah.php" method="post">
      ...
      <div class="menu">
        <ul class="list">
          ...
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/staf/skp-saya.php">SKP - Saya</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/staf/realisasi-saya.php">Realisasi - Saya</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="pages/staf/arsip.php">
    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          <div class="header">
            <h2>
              Selamat Datang Di Halaman Staf, <strong><?= $staf["NAMA"] ?></strong>
            </h2>
          </div>
          <div class="body">
            <div class="row clearfix">
