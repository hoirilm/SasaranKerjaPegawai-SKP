...
require 'pages/kabid/notif.php';
require 'pages/kabid/reset-error.php';
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="" action="pages/kabid/proses-ubah.php" method="post">
      ...
      <div class="menu">
        <ul class="list">
          ...
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/kabid/skp-kasi.php">SKP - Kepala Seksi</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/kabid/realisasi.php">Realisasi - Kepala Seksi</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/kabid/arsip-kasi.php">Arsip - Kasi</a>
              </li>
            </ul>
          </li>
      </ul>
    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          <div class="header">
            <h2>
              Selamat Datang Di Halaman Kabid, <strong><?= $kabid["NAMA"] ?></strong>
            </h2>
          </div>
          <div class="body">
            <div class="row clearfix">
