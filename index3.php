...
require 'pages/kasi/notif.php';
require 'pages/kasi/reset-error.php';
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="" action="pages/kasi/proses-ubah.php" method="post">
      ...
      <div class="menu">
        <ul class="list">
          ...
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/kasi/skp-saya.php">SKP - Saya</a>
              </li>
              <li>
                <a href="pages/kasi/skp-staf.php">SKP - Staf</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/kasi/realisasi-saya.php">Realisasi - Saya</a>
              </li>
              <li>
                <a href="pages/kasi/realisasi-staf.php">Realisasi - Staf</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="pages/kasi/arsip.php">Arsip - Saya</a>
              </li>
              <li>
                <a href="pages/kasi/arsip-staf.php">Arsip - Staf</a>
              </li>
            </ul>
          </li>
        </ul>
    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          <div class="header">
            <h2>
              Selamat Datang Di Halaman Kasi, <strong><?= $kasi["NAMA"] ?></strong>
            </h2>
          </div>
          <div class="body">
            <div class="row clearfix">
