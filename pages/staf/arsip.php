    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="modal_profile_kabid">Profile</h4>
        </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" style="width: 100%">
                  ...
                  <tbody>
                    ...
                    $statement = $koneksi -> query("SELECT * FROM NILAI_KERJA WHERE NIP = '$nip' ORDER BY TGL_NILAI desc");
                      ...
                      <?php foreach ($nilai_kerja as $key) { ?>
                        <tr>
                          ...
                          <td class="align-center">
                            <!-- <form action="cetak-nilai-kerja.php" style="display: inline" method="post" target="_blank">
                            <input type="hidden" name="idnilai" value="<?= $key["ID_PENILAIAN"] ?>">
                            <button type="submit" style="background-color: Transparent; border: none; color: #2196F3;">
                            <i class="material-icons">print</i>
                          </button>
                        </form> -->

                        <!-- <button type="submit" data-toggle="modal" data-target="#cetak_arsip" id="<?= $key['ID_PENILAIAN']; ?>" target style="background-color: Transparent; border: none; color: #2196F3;">
                        <i class="material-icons">print</i>
                      </button> -->
