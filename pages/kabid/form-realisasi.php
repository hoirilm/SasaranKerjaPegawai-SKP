...
<?php function realisasi(){ ?>
   ...
   <body>
      ...
      WHERE user.NIP = '$nipkasi' AND YEAR(skp.TGL_SKP) = '$tgl'";
      ...
      $statement2 = $koneksi -> query("SELECT * FROM SKP WHERE ID_STATUS = 2 AND NIP = '$nipkasi' AND YEAR(TGL_SKP) = '$tgl'");
            ...
            <div class="modal-content modal-col-red">
               ...
               <div class="modal-body js-sweetalert">
                  <div class="alert bg-red align-center">
                     ...
                     <h5>Tidak dapat memberi nilai pada Kasi yang bersangkutan. Pastikan semua SKP sudah disetujui.</h5>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="modal-dialog" role="document" style="width: 98%;">
            <div class="modal-content modal-col-red">
               ...
               <div class="modal-body js-sweetalert">
                  <div class="alert bg-red align-center">
                     <i class="material-icons">info</i>
                     <h5>Kasi tidak memiliki SKP untuk dinilai</h5>
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <table class="table">
                                 ...
                                 <?php foreach ($skp as $key){ ?>
                                    <tbody>
                                       ...
                                       <input type="hidden" name="nip[]" value="<?= $nipkasi ?>">
                                       <td>
