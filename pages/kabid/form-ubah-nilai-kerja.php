                                ...
                                <table class="table table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input style="border-left: none;border-right: none;border-top: none;width: 100%;text-align: center;font-weight: bold;" type="text" name="kepemimpinan" value="" required></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
