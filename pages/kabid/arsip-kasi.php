...
<body class="theme-indigo">
      ...
      <div class="menu">
        <ul class="list">
          ...
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="skp-kasi.php">SKP - Kasi</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="ml-menu">
              <li>
                <a href="realisasi.php">Realisasi - Kasi</a>
              </li>
            </ul>
          </li>
    ...
    <div class="container-fluid">
      ...
      <div class="row clearfix js-sweetalert">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
          <div class="card">
            <div class="header">
              <form class="" action="arsip-kasi.php" method="post">
                <?php
                ...
                <div class="form-group" style="margin:0" style="width: 30%">
                  ...
                  <select class="pengguna" name="nama">
            ...
            if (isset($_POST["cari"])) {
              ...
              // $thnsekarang = date("Y");
              $query = "SELECT * FROM NILAI_KERJA INNER JOIN USER ON NILAI_KERJA.NIP = USER.NIP WHERE USER.NIP = '$nipkasi' AND YEAR(TGL_NILAI) = '$periode' ORDER BY ID_PENILAIAN DESC";
                        ...
                        <?php foreach ($nilai_kerja as $key) { ?>
                          <tr>
                            ...
                            <td class="align-center">
                              <button type="submit" class="modal_cetak_arsip" id="<?= $key['ID_PENILAIAN']; ?>" name="<?= $nipkasi ?>" style="background-color: Transparent; border: none; color: #2196F3;">
  ...
  $(document).ready(function () {
    $(".modal_cetak_arsip").click(function(e) {
      ...
      var nipkasi =  $(this).attr("name"); //ambil nilai dari atribut name
      $.ajax({
        url: "form-tanggal-kasi.php",
        type: "GET",
        data : {'ID_PENILAIAN': id, 'NIP': nipkasi},
