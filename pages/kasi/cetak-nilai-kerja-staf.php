...
// AMBIL DATA PENGGUNA
$nipstaf = $_POST["nipstaf"];
$statement = $koneksi -> query("SELECT * FROM USER INNER JOIN PANGKAT ON USER.ID_PANGKAT = PANGKAT.ID_PANGKAT INNER JOIN JABATAN ON USER.ID_JABATAN = JABATAN.ID_JABATAN INNER JOIN POSISI_JABATAN ON USER.ID_POSISI_JABATAN = POSISI_JABATAN.ID_POSISI_JABATAN WHERE USER.NIP = '$nipstaf'");
...
$a = $koneksi -> query("SELECT * FROM USER  INNER JOIN PANGKAT ON USER.ID_PANGKAT = PANGKAT.ID_PANGKAT  INNER JOIN JABATAN ON USER.ID_JABATAN = JABATAN.ID_JABATAN  INNER JOIN POSISI_JABATAN ON USER.ID_POSISI_JABATAN = POSISI_JABATAN.ID_POSISI_JABATAN  WHERE USER.ID_JABATAN = 1");
...
$b = $koneksi -> query("SELECT * FROM realisasi
  ...
  WHERE realisasi.NIP = '$nipstaf' AND YEAR(TGL_SKP) = '$tgl'");
