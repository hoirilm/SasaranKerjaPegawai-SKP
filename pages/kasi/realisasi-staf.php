    ...
    <div class="container-fluid">
      ...
      <div class="row clearfix js-sweetalert">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
          <div class="card">
            <div class="header">
              <form class="" action="realisasi-staf.php" method="post">
                <?php
            ...
            <?php if (!isset($_POST["cari"])){ ?>
              ...
              <div class="body">
                <p><strong>Pilih nama staf untuk menilai</strong></p>
              </div>
            ...
            <?php } else if (isset($_POST["cari"])){ ?>
              ...
              $nipstaf = $_POST["nama"];
              $pencarian = $koneksi -> query("SELECT DISTINCT NIP, NAMA FROM USER WHERE NIP = '$nipstaf'");
              ...
              $tgl = date("Y");
              $cekrealisasi = $koneksi -> query("SELECT * FROM realisasi WHERE NIP = '$nipstaf' AND YEAR(TGL_REALISASI) = '$tgl'");
              ...
              $ceknilaikerja = $koneksi -> query("SELECT * FROM nilai_kerja WHERE NIP = '$nipstaf' AND YEAR(TGL_NILAI) = '$tgl'");
              // while ($row = $cekrealisasi -> fetch(PDO::FETCH_ASSOC)){
