...
if (isset($_POST["simpan_realisasi"])){
   ...
   for ($i=0; $i < $jumlahskp; $i++) {
      ...
      // var_dump($_POST['kuantoutput1'][$i]);echo "<br>";
      // var_dump($kuantInput);echo "<br>";
      // var_dump($kuantDb);echo "<br>";
      // var_dump($error);echo "<br>";echo "<br>";echo "<br>";
      // // die;
      //
      // var_dump($_POST['kualmutu'][$i]);echo "<br>";
      // var_dump($kualInput);echo "<br>";
      // var_dump($kualDb);echo "<br>";
      // var_dump($error);echo "<br>";echo "<br>";echo "<br>";
      // // die;
      //
      // var_dump($_POST['waktu1'][$i]);echo "<br>";
      // var_dump($waktuInput);echo "<br>";
      // var_dump($waktuDb);echo "<br>";
      // var_dump($error);echo "<br>";echo "<br>";echo "<br>";
      // die;

      // var_dump($tampungKuant);
      // var_dump($tampungKual);
      // var_dump($tampungWaktu);
      // die;
...
if (isset($_POST['simpan_nilai_kerja'])){
   ...
   if ($error == false) {
      ...
      // $statement -> bindValue(':NILAI_PERILAKUKERJA', $nilai_perilaku_kerja);
      // $statement -> bindValue(':NILAI_PRESTASIKERJA', $nilai_prestasi_kerja);
