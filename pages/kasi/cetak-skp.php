...
<body>
  <div style="font-family: calibri; width: 100%">
    ...
    <table class="tg">
      ...
      <tr>
        <td class="tg-baqh">1<br>2<br>3<br>4<br><br>5</td>
        <td class="tg-yw4l">Nama<br>NIP<br>Pangkat/Gol.Ruang<br>Jabatan<br><br>Unit Kerja</td>
        <td class="tg-yw4l">
          ...
          $statement = $koneksi -> query("SELECT * FROM USER
            ...
            WHERE USER.ID_JABATAN = 1 AND USER.ID_POSISI_JABATAN = 1");
            while ($row = $statement -> fetch(PDO::FETCH_ASSOC)){
              $atasan[] = $row;
            }
            ?>
          ...
          <td class="tg-baqh">1<br>2<br>3<br>4<br><br>5</td>
          <td class="tg-yw4l" colspan="2">Nama<br>NIP<br>Pangkat/Gol.Ruang<br>Jabatan<br><br>Unit Kerja</td>
